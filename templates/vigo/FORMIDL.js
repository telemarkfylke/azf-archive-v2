  ...
  archiveTemplate: (archiveData) => {
    ...
    return {
      ...
      parameter: {
        ...
        ResponsiblePersonRecno: NODE_ENV === 'production' ? '200472' : '200249', // Seksjon Fag- og yrkesopplæring (vfk) Team fag-, yrkes- og voksenopplæring (tfk) (vfk-test: 200019, vfk-prod: 200016) (tfk-test: 200249, tfk-prod: 200472)
